...
public class GalleryRecyclerView extends RecyclerView {
     ...
     * 布局器构建者
     */
    private GalleryLayoutManger.Builder mManagerBuilder;
    ...
    private void createManageBuilder() {
        if (mManagerBuilder == null) {
            mManagerBuilder = new GalleryLayoutManger.Builder();
        }
    }
    ...
    public void setIntervalScale(float scale) {
        createManageBuilder();
        mManagerBuilder.setIntervalScale(scale);
        setLayoutManager(mManagerBuilder.build());
    }

    @Override
    public void setLayoutManager(LayoutManager layout) {
        if (!(layout instanceof GalleryLayoutManger)) {
     ...
     */
    public GalleryLayoutManger getCoverFlowLayout() {
        return ((GalleryLayoutManger) getLayoutManager());
    }
    ...
    public int getScrollState() {
        return getCoverFlowLayout().scrollState;
    }
     ...
     * @param l 监听接口
     */
    public void setOnItemSelectedListener(GalleryLayoutManger.OnSelected l) {
