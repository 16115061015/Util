package com.example.UiDemo.layout;
...
public class FreshLayout extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        //初始参数
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.FreshLayout);
        lenghtofpulldown = typedArray.getDimension(R.styleable.FreshLayout_LengthOfPullDown, 200);
        FreshViewHeight = typedArray.getDimension(R.styleable.FreshLayout_HeightOfView, 200);
        int id = typedArray.getResourceId(R.styleable.FreshLayout_HeadRefreshView, -1);
        int id2 = typedArray.getResourceId(R.styleable.FreshLayout_DownRefreshView, -1);
